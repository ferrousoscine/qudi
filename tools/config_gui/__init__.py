...
if "PyQt4" in sys.modules:
    ...
    for api in ["QString", "QVariant"]:
        try:
            ...
            if v != 2:
                raise Exception(
                    "We require the usage of API version 2 for "
...
if set_api:
    try:
        ...
        print(
            "Import Error in core/__init__.py: no sip module found. Implement the error handling!"
        )
...
if sys.platform == "win32":
    try:
        ...
        print(
            "SetCurrentProcessExplicitAppUserModelID failed! This is probably not Microsoft Windows!"
        )
