...
class SimpleDataLogic(GenericLogic):
    ...
    def startMeasure(self):
        ...
        self.smooth = np.zeros(
            (self.bufferLength + self.window_len - 1, self._data_logic.getChannels())
        )
    ...
    def measureLoop(self):
        ...
        s = np.r_[
            self.buf[self.window_len - 1 : 0 : -1], self.buf, self.buf[-1 : -self.window_len : -1]
        ]
