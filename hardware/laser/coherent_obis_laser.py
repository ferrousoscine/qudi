...
from interface.simple_laser_interface import LaserState, ShutterState, SimpleLaserInterface
...
class OBISLaser(Base, SimpleLaserInterface):
    ...
    def get_control_mode(self):
        ...
        """
        self.log.warning(
            self._model_name + " does not have control modes, cannot get current mode."
        )
    ...
    def set_control_mode(self, mode):
        ...
        """
        self.log.warning(
            self._model_name + f" does not have control modes, cannot set to mode {mode}"
        )
    ...
    def set_power(self, power):
        ...
        """
        self._communicate(f"SOUR:POW:LEV:IMM:AMPL {power}")
    ...
    def set_current(self, current_percent):
        ...
        """
        self._communicate(f"SOUR:POW:CURR {current_percent}")
    ...
    def get_extra_info(self):
        ...
        """
        extra = (
            "System Model Name: " + self._communicate("SYST:INF:MOD?") + "\n"
